...
* the time accuracy of your observation, i.e., 
    ...
    * in eruption, if you oberved the eruption, but not from the start, 
    * electronic, if the eruption was determined by electronic equipement (e.g. temperature logger or seismometer), 
    * approximate, if you observed the eruption, but did not note the exact time and therefore approximate it, or if you know an eruption has occured, but do not know its start time (e.g. for overnight eruptions), 
* (optionally) the duration of the eruption, 
* as required additional labels, i.e., 
    * the webcam label, if you observed the eruption on the webcam, 
    * the intial label, if you observed the initial eruption of a series of a geyser known to erupt in series (e.g. Lion),
    * the questionable label, if you think an eruption occured, but aren't sure, 
    * the major or minor label (or the long or short label for Old Faithful), if you observed a major or minor eruption of a geyser known to erupt in a bimodal way (e.g. Old Faithful or Castle),
