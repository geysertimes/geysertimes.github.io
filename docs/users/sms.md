...
Historically, access to GeyserTimes' data within Yellowstone National Park has been limited to areas with cell service, and among all geyser basins, only the Upper Geyser Basin has adequate coverage. Since September 2024, Apple supports satellite SMS messaging, and major mobile network operators have inked deals with satellite providers. T-Mobile has partnered with SpaceX's Starlink, who have launched their direct-to-cell service in the middle of 2025, and both AT&T and Verizon have invested in AST SpaceMobile, which has deployed their first batch of satellites in early 2025.
...
Please note that standard messaging rates apply, so keep this in mind if your plan does not include unlimited texts. GeyserTimes incurs both a fixed monthly fee for its phone number and per-message fees. If you are willing and able to assist with expenses, please consider a [donation](http://geysertimes.org/donate.php).
...
| Supported Devices                                                                                   | Carrier                           | Cost                                                               | Status                     |
|:----------------------------------------------------------------------------------------------------|:----------------------------------|:-------------------------------------------------------------------|:---------------------------|
| Garmin inReach                                                                                      | carrier-independent               | [see plans](https://www.garmin.com/en-US/p/837461/pn/010-06002-SU) | 🟨 partial support[^1]     |
| ZOLEO                                                                                               | carrier-independent               | [see plans](https://www.zoleo.com/en-us/plans)                     | 🟩 full support (untested) |
| iPhone 14 or later running iOS 18+                                                                  | all                               | incl. with device                                                  | 🟩 full support            |
| 60+ devices ([see list](https://www.t-mobile.com/support/coverage/satellite-support))               | T-Mobile (open to other carriers) | $10/month (incl. in some premium plans)                            | 🟩 full support (untested) |
| Samsung Galaxy S25 and Google Pixel 9 ([see list](https://www.verizon.com/support/satellite-faqs/)) | Verizon                           | incl. in all plans                                                 | 🟩 full support (untested) |
...
To date, there have been no concrete announcements when AT&T's and Verizon's service in partnership with AST SpaceMobile will launch. It is expected that the number of eligible devices will further grow once that constellation is operational. This includes devices on Verizon, which currently has a supplementary partnership with Skylo to enable its satellite messaging offering.
...
* The <kbd>last note</kbd> keyword [retrieves the latest note](#retrieve-last-note) of a given geyser.
...
* The <kbd>enter note</kbd> keyword allows users to [submit a note](#submit-note). To properly attribute incoming entries, you'll need to [connect your phone number](/users/account#connect-a-phone-number) with your GeyserTimes account. This must be done beforehand while cell service is still available.
...
**Example:** last note <Highlight color="#4cb3d4">Great Fountain</Highlight>

* <Highlight color="#4cb3d4">Geyser name</Highlight> for which to retrieve latest note. Must exactly match a geyser in the GeyserTimes database, safe for capitalization.
...
**Example:** enter note <Highlight color="#4cb3d4">Great Fountain</Highlight> <Highlight color="#e6a700">2025-07-27 2245 - 2025-07-28 0015</Highlight> <Highlight color="#d4d5d8">beautiful display of northern lights reflecting in terraces</Highlight>

* <Highlight color="#4cb3d4">Geyser name</Highlight> of geyser that was observed. Must exactly match a geyser in the GeyserTimes database, safe for capitalization.
* <Highlight color="#e6a700">Date and time (range)</Highlight> at or during which the geyser was observed. The date part is optional and, when missing, will be assumed to be today in the geyser's timezone. The second date and time, including the "-" sign, are optional. When the second date is missing, it will be assumed to be the same as the first.
* <Highlight color="#d4d5d8">Note</Highlight> that further describes the observations. Given the SMS limit of 160 characters you'll likely need to keep this short and concise. No brackets needed.
...
* Submitted eruptions and notes do not initially support observers. This is to reduce character count and simplify syntax requirements, given its limited practical value. If you think we should reconsider this, please reach out.
